...
uint32_t score; /**< Score du jeu. */
uint32_t score1; /**< Dizaine du score. */
uint32_t score2; /**< Unité du score. */
uint32_t high10; /**< Dizaine du meilleur score. */
uint32_t high1; /**< Unité du meilleur score. */
uint32_t highscore = 0; /**< Meilleur score. */

static volatile uint32_t t = 0; /**< Temps en millisecondes. */

/**
 * @brief Fonction pour gérer le temps en millisecondes.
 */
...
/**
 * @brief Effectue un clignotement lumineux au démarrage du jeu.
 */
void clignotement() {
